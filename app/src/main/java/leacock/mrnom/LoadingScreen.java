...
import leacock.mrnom.framework.Graphics.PixmapFormat;
...
public class LoadingScreen extends Screen{
    ...
    public void update(float deltaTime){
        ...
        Assets.headUp = g.newPixmap("enemyUD.png", PixmapFormat.ARGB4444);
        Assets.headLeft = g.newPixmap("enemyLR.png", PixmapFormat.ARGB4444);
        Assets.headDown = g.newPixmap("enemyUD.png", PixmapFormat.ARGB4444);
        Assets.headRight = g.newPixmap("enemyLR.png", PixmapFormat.ARGB4444);
       /*
